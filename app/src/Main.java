public class Main {
    public static void main(String[] args) {
        ...
        mathFaculty.addCourse(course1);
        mathFaculty.addStudent(student1);
        physFaculty.addTeacher(teacher2);
        ...
        university.assignTeacherToCourse(teacher2, course3);
        university.unsubscribeStudentInCourse(student2, course3);
        university.cancelTeacherToCourse(teacher2, course3);
        university.getInfoTeachersAndStudents();
        university.getInfoFaculties();
    }
}
